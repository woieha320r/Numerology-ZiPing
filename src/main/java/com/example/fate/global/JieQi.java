...
import com.example.fate.utils.CycleIndexUtil;
...
public enum JieQi {
     ...
     */
    @Getter(AccessLevel.NONE)
    private static final JSONArray JIE_QI_TIME = JSONUtil.parseArray(FileUtil.readString("/Users/xiamu/Documents/Projects/Fate/src/main/resources/jieQi.json", StandardCharsets.UTF_8));
    @Getter(AccessLevel.NONE)
